...
using Sprite_Death_and_Respawn.Models;
using Sprite_Death_and_Respawn.Sprites;

namespace Sprite_Death_and_Respawn
{
    /// <summary>
    ...
    public class Game1 : Game
    {
        ...
        {
            var playerTexture = Content.Load<Texture2D>("goldKnight");
